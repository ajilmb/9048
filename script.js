...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderContact() {
        dynamicContainer.innerHTML = `
            <div class="content-wrapper contact-content" style="display:flex; flex-direction:column; justify-content:center; height:100%; text-align: center;">
                ...
                <!-- Icons Row -->
                <div class="social-icons-row" style="display:flex; gap:30px; justify-content:center; align-items:center;">
                    
                    <!-- MAIL -->
                    <a href="mailto:mathewsb2001@gmail.com" class="icon-link" aria-label="Email">
            ...
            setTimeout(() => {
                ...
                if (deviceFrame) {
                    ...
                    setTimeout(() => {
                        ...
                        if (mbImage) {
                            setTimeout(() => {
                                mbImage.classList.remove('animate-ghost'); // Ensure no ghost yet
                                mbImage.style.display = 'block';
                                mbImage.style.opacity = '0'; // Ensure start state
                                ...
                                // Wait for fade-in (2s) to finish before ghosting
                                setTimeout(() => {
                                    mbImage.classList.add('animate-ghost');
                                }, 2000);
                            }, 1000); // "After a second or moment" delay
                        }
